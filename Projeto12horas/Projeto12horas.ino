...
#define PUMP_PIN 8
#define PUMP_INTERVAL 43.200.000   // Intervalo de salvamento ajustado para 12 horas
#define PUMP_DURATION 50000
 ...
 if(p==7)
{
 ...
 digitalWrite(L6,0); 
  ...
  delay(3000); // Pequena pausa entre as iterações para melhorar a responsividade
}
}
